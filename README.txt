...
us errors. Similarly, just being able to interact with the database and backend made it all the more fun and interesting, as we got to see in real-time, the changing of passwords and the termination
of accounts.
  Lastly, if we had more time, we would've liked to have added the scheduling and meetings between the current user and other contacts, as well as added different calendar themes that the user can
